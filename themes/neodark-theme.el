...
(autothemer-deftheme
	neodark "A theme inspired by Astronvim"
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (sumiInk-0		"#181a1f" "#000000")
  (sumiInk-1b		"#1e222a" "#000000")
  (sumiInk-1		"#1e222a" "#080808")
  (sumiInk-2		"#282c34" "#121212")
  (sumiInk-3		"#4b5263" "#303030")
  (sumiInk-4		"#777d86" "#303030")

  (waveBlue-1		"#181a1f" "#4e4e4e")
  (waveBlue-2		"#90c7f3" "#585858")
  (waveAqua1		"#56b6c2" "#6a9589")
  (waveAqua2		"#88cbd4" "#717C7C")

  (winterGreen		"#98c378" "#585858")
  (winterYellow		"#49443c" "#585858")
  (winterRed		"#e06c75" "#585858")
  (winterBlue		"#1b1f27" "#585858")

  (autumnGreen		"#89b06d" "#585858")
  (autumnRed		"#cc626a" "#585858")
  (autumnYellow		"#e5c07b" "#585858")

  (samuraiRed		"#ec5f67" "#585858")
  (roninYellow		"#ff9640" "#585858")

  (dragonBlue		"#8094b4" "#658594")
  (fujiGray             "#787e87" "#717C7C")
  (springViolet1	"#a9a1e1" "#717C7C")
  (oniViolet		"#c678dd" "#717C7C")
  (crystalBlue		"#8094b4" "#717C7C")
  (springViolet2	"#c2bdea" "#717C7C")
  (springBlue		"#56b6c2" "#717C7C")
  (lightBlue		"#88cdb4" "#717C7C")
  (springGreen		"#98c378" "#717C7C")
  (boatYellow1		"#d19a66" "#717C7C")
  (boatYellow2		"#d1b071" "#717C7C")
  (carpYellow		"#e5c07b" "#717C7C")
  (sakuraPink		"#d47d85" "#717C7C")
  (waveRed              "#e06c75" "#717C7C")
  (peachRed             "#FF5D62" "#717C7C")
  (surimiOrange		"#ff9640" "#717C7C")
