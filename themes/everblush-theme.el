...
(everblush-with-color-variables
  (custom-theme-set-faces 'everblush
                          ...
                          `(mode-line ((t (:foreground ,everblush-white :background ,everblush-black :weight normal
                                                       :box (:line-width ,mode-line-padding :color ,everblush-black)))))
                          `(mode-line-inactive ((t (:foreground ,everblush-comment :background ,everblush-black :weight normal :box (:line-width ,mode-line-padding :color ,everblush-black)))))
                          ...
                          `(linum ((t (:background ,everblush-bg :foreground ,everblush-white))))
