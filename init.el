...
(custom-set-variables
 ...
 '(package-selected-packages
	 '(simpleclip org-bullets kaolin-themes editorconfig key-chord general magit all-the-icons-dired all-the-icons doom-modeline doom-themes rainbow-delimiters evil-collection evil marginalia consult orderless vertico use-package)))
(custom-set-faces
